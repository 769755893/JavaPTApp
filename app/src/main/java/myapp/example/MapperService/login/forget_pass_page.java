package myapp.example.MapperService.login;
...
import myapp.example.MapperService.login.request.Forget_request;
                ...
                if(fragmentisclose) {
                    ...
                    dateSelectFragment.FragmentCallbackInterface(new DateSelectFragment.FragmentInterface() {
                        ...
                        public void sendremovemsg() {
                            ...
                            fragmentisclose = true;
                        }
                    });
                    fragmentisclose = false;
                }
                break;
